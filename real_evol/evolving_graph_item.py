...
def graph_main(fin, num, pace):
    ...
    weiseq = binw[:20000]
    phi_wei = DataFit(xind[1:100], weiseq[1:100])
...
def evol():
    ...
    filename_in = '../RealDatasetValidation/data/amazon/' + csv[1].replace('ratings_','') +'_dump.txt'
    for i in range(10):
        if i!=0:
            graph_main(filename_in, i, int(22507155/10))
            print("")
